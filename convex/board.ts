...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!isSubscribed && existingBoards.length >= ORG_BOARD_LIMIT) {
      throw new Error("You have reached the limit of boards per organization");
    }
...
export const remove = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!identity) {
      throw new Error("You must be authenticated to remove a board");
    }
...
export const update = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!identity) {
      throw new Error("You must be authenticated to update a board");
    }
...
export const favorite = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!identity) {
      throw new Error("You must be authenticated to favorite a board");
    }
    ...
    if (existingFavorite) {
      throw new Error("Board is already a favorite");
    }
...
export const unfavorite = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!existingFavorite) {
      throw new Error("Favorited board does not exist");
    }
